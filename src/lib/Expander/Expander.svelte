...
<div class="expander direction-{direction} {className ?? ''}" role="region" aria-expanded={expanded} class:expanded bind:this={element} {...$$restProps}>
    <div class="expander-header" on:keydown={handleKeydown} tabindex="0" on:click={() => expanded = !expanded}>
        {#if $$slots.icon}
